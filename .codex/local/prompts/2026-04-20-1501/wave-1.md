Continue request-driven wave campaign `2026-04-20-1501`.
Wave 1 of 3 is next.
Remaining waves after this one: 2.
...
### 2026-04-20-1501/wave-1

- Compatibility benchmark command: `python3 run_verify_timed.py 65536 --repeats 1`
- Decision benchmark command: `controller median of order-balanced direct runs (org/improve, improve/org, org/improve)`
- Compatibility `improve` execution_ms: `227.011`
- Compatibility `org` execution_ms: `140190.432`
- Compatibility execution ratio vs `org`: `0.001619`
- Decision `improve` execution_ms: `pending controller`
- Decision `org` execution_ms: `pending controller`
- Decision execution ratio vs `org`: `pending controller`
- New best: `pending controller`
- Notes: Replaced the fallback Machin implementation with a single-core integer Chudnovsky binary-splitting path, added a small leaf cutoff, and lifted Python's large-int string formatting limit for 65536-digit output.
